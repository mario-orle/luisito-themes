<?php
/**
 * Template Name: page-crear-inmueble-mbl.html
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    wp_redirect("/inmueble-mbl-detail?inmueble_id=" . $inmueble_id);
...
<main id="primary" class="site-main">
    ...
    <div class="main">
    <form id="regForm" method="POST" enctype="multipart/form-data" style="min-width: auto;">
      <h1>Inmueble</h1>
